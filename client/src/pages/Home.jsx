    ...
    <section className="max-w-7xl mx-auto">
      ...
      <div>
        <h1 className="font-extrabold text-[#222328]
         ...
         <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">Browse through a collection of imaginative and
      ...
      <div className="mt-10">
        {loading ? (
          ...
          <>
            {searchText && (
              <h2 className="font-medium text-[#66e75]
              text-xl mb-3">
                Showing results for <span className="text-
                [#2223238]">{searchText}</span>
              </h2>
            )}
